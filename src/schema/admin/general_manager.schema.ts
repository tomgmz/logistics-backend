...
export const createGeneralManagerSchema = z.object({
  first_name:     z
                  .string()
                  .min(2)
                  .max(50)
  ...
  phone: z
        .string()
        .regex(/^\+63[2-9][0-9]{8,9}$/, 'Phone must be a valid PH mobile or landline number')
        .transform(v => v === '' ? null : v),
  created_by:     z.string().uuid().optional().nullable(),
})

export const updateGeneralManagerSchema = z.object({
  first_name:     z
                  .string()
                  .min(2)
                  .max(50)
