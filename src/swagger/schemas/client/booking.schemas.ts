export const bookingSchemas = {
  CreateBookingRequest: {
    ...
    properties: {
      ...
      stackable_required:  { type: 'boolean', nullable: true, example: false },
      destinations: {
        type: 'array',
        minItems: 1,
        items: {
          ...
          properties: {
            ...
            latitude:       { type: 'number', nullable: true, example: 14.6333 },
            longitude:      { type: 'number', nullable: true, example: 121.0437 },
